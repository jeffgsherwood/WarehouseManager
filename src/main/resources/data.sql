SET FOREIGN_KEY_CHECKS = 0; # This must be the very first executable statement

TRUNCATE TABLE products; # This clears the child table
TRUNCATE TABLE warehouses; # This clears the parent table
